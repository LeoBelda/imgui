...
// Functions
static void ImGui_ImplDX12_SetupRenderState(const ImDrawData* draw_data, ID3D12GraphicsCommandList* command_list, ImGui_ImplDX12_RenderBuffers* fr)
{
    ...
    command_list->SetDescriptorHeaps(1, &bd->pd3dSrvDescHeap);
